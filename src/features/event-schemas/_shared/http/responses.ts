...
export const eventSchemaResponseSchema = t.Object({
  ...
  managementMode: t.Union([t.Literal("manual"), t.Literal("external")]),
  managementSource: t.Nullable(t.String()),
...
export function toEventSchemaResponse({
  ...
  return {
    ...
    managementMode: family.managementMode,
    managementSource: family.managementSource,
